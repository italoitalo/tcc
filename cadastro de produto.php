<?php
session_start();
if( $_SESSION['funcionario'] == 1 or $_SESSION['user_id'] == 2)
{
...
<h1>Cadastro de produto</h1>
    <hr>
      <form method="post" action="php/registro de produto.php" enctype="multipart/form-data">
        <table>
          <tr>
          ...
          <tr>
            ...
            <td><input type="number" name="preco" min="1" step="0.01""></td>
          </tr> 
            <tr>   
