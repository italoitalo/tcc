...
<section class="imagemProduto">
  ...
  <img src="img/Egg Masturbador Masculino no Atacado Kit com 6 Unidades Magical Kiss.jpg">
  	...
  	<div class="coluna col6">
  		...
  		<h2> $R$20,00</h2>
      <h4> Descrição: $Descrição fabricante: $fabricante</h4>
      <table>
      <form action="">
        Quantidade a comprar: <input type="number" name="quantity" min="1" max="3"></input>
        <br></br>
        modelo: <input type="number" name="quantity" min="10" max="20"></input>        
        <br></br>
